...
@section('page-content')
    <br>
    <br>
    <h1 class="text-center" style="color: red;">Welcome to Employee information System</h1>
    <!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<body>
    <a href="{{ route('/add-employee') }}" style="background-color: purple; float:left;text-decoration:none;padding:15px;margin-left:20px;margin-top:20px;" class="btn btn-primary"> + Add Emplyee</a>
    <br>
    <br>
    <br>
